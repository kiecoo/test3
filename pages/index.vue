<template>
  <div>
<!-- test1 Navbar.vue暫移放這 -->

    <!-- 替代 原本（未改成test1前） <Navbar :cities="cities" :typeOptions="items"/> -->
...
// import Navbar from '~/components/Navbar.vue'  //因 test1 Navbar.vue暫移放這 （而改）
...
export default {
  components: {
    Logo,
    VuetifyLogo,
    // Navbar,  //因 test1 Navbar.vue暫移放這 （而改）
    ShopList,

    SearchSidebar  //因 test1 Navbar.vue暫移放這 （而add此）
  },
  data() {
    return {
      ...
      typeOptions: [
      //items: [      >>>原本為此行    //因 test1 Navbar.vue暫移放這 （而改）
        {
          value: null,
          icon: null,
          type: null,
